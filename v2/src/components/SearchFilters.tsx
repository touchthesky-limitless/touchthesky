...
export default function SearchFilters() {
	const { banks, activeBanks, toggleBank, activeAlliances, toggleAlliance } =
		useAirlines();
	...
	return (
		...
		<div className="w-full space-y-6 animate-in fade-in slide-in-from-top-4 duration-700">
			...
			<div className="flex flex-nowrap gap-3 overflow-x-auto no-scrollbar -mx-5 px-5 pb-3 scroll-smooth">
				{banks.map((bank) => {
