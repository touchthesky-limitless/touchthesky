			...
			<div className="flex flex-col items-center gap-8">
				...
				<div className="flex flex-col items-center gap-3 font-mono">
					<div className="flex items-center gap-3 px-3 py-1.5 bg-slate-100 dark:bg-slate-900 rounded-full border border-slate-200 dark:border-slate-800 shadow-inner">
						{/* Status Light */}
						<div
							className={`w-2 h-2 rounded-full ${isSyncing ? "bg-blue-500 animate-ping" : "bg-emerald-500"} shadow-[0_0_8px_rgba(16,185,129,0.5)]`}
						></div>

						<p className="text-[10px] uppercase tracking-tighter text-slate-500 dark:text-slate-400">
							SYS_STATUS:{" "}
							<span className="text-slate-900 dark:text-slate-200 font-bold">
								{isSyncing ? "SYNCING_PARTNERS" : "EN_ROUTE_STABLE"}
							</span>
						</p>
				...
				<div className="flex flex-col items-center gap-1">
					...
					<p className="text-[9px] text-slate-400 font-medium uppercase tracking-tight">
						Architected by{" "}
						<span className="text-blue-500 font-bold underline decoration-blue-500/30 underline-offset-2">
							Gemini Protocol
						</span>
					</p>
				</div>
				...
				<div className="relative group cursor-default">
					...
					<svg
						className="w-6 h-6 relative text-slate-500 dark:text-slate-400 opacity-30 group-hover:opacity-80 transition-all duration-500"
						fill="currentColor"
						viewBox="0 0 24 24"
					>
