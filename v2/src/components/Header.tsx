import { useAirlines } from "../hooks/useAirlines"; // Adjust path as needed
...
export default function Header({
	...
	// Pull global state directly from context
	const { isDark, setIsDark, search, setSearch } = useAirlines();

	return (
		<header
			className={`sticky top-0 z-30 bg-white/90 dark:bg-black/90 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 p-4 transition-transform duration-300 ${
			...
			<div className="max-w-4xl mx-auto flex flex-col gap-4">
				...
				<div className="flex justify-between items-center">
					...
					<div className="flex items-center gap-2">
						...
						<button
							...
							className="cursor-pointer p-2 rounded-full bg-slate-100 dark:bg-slate-800 transition-colors"
						>
							{isDark ? "☀️" : "🌙"}
						</button>
					</div>
				...
				<nav className="flex items-center gap-6">
					...
					>
						...
						>
							<path
								d="M21 16l-2-3.5V5a2 2 0 10-4 0v1l-7 4H4l-1 1 4 2-1 3 2 1 2-2 7 4h2l-1-4.5 3-1.5z"
								stroke="currentColor"
								fill="none"
							/>
						</svg>
